...
class ViewController: UIViewController {
    ...
    var sections = [
        MySection(section: "첫 번째", items: [MyModel(message: "jake"), MyModel(message:"jake의 iOS")]),
        MySection(section: "두 번째", items: [MyModel(message:"jake의 iOS앱 개발 알아가기"), MyModel(message:"jake의 iOS앱 개발 알아가기\njake의 iOS앱 개발 알아가기")]),
        SectionModel(section: "세 번째", items: [MyModel(message:"jake의 iOS앱 개발 알아가기\njake의 iOS앱 개발 알아가기\njake의 iOS앱 개발 알아가기\njake의 iOS앱 개발 알아가기")])
    ]
